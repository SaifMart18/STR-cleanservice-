...
export const AR_TRANSLATIONS: TranslationDict = {
  ...
  whyFeatures: [
    ...
    { id: 4, title: "أسعار مناسبة", description: "نوازن بين الجودة الفائقة وعروض الأسعار العادلة التي تناسب الاحتياجات المختلفة." },
...
export const EN_TRANSLATIONS: TranslationDict = {
  ...
  whyFeatures: [
    ...
    { id: 4, title: "Affordable Transparent Rates", description: "Get maximum premium results without hidden auxiliary charges or fees. We deliver exceptional return on premium quality." },
